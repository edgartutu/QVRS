  ...
  <div style="color:teal;">
    <v-card>
      <v-layout row wrap justify-space-around>
        <v-flex xs12 md12>
          <v-card height="6" class="black"></v-card>
        </v-flex>
        <v-flex xs12 md12>
          <v-card height="5" class="yellow accent-2"></v-card>
        </v-flex>
        <v-flex xs12 md12>
          <v-card height="5" class="red accent-4"></v-card>
        </v-flex>
      </v-layout>
      ...
      <marquee-text :duration="40" :repeat="3" dark class="teal white--text mt-2">
        <v-layout row justify-space-around>
          <v-flex xs10 md2>
            <v-card min-width="250" max-height="120" outlined flat>
              <v-row class="fill-height">
                ...
                votes
                <div>
                  <strong style="font-size:15px">FDC</strong>
                </div>
              </v-row>
            </v-card>
          </v-flex>
          <v-flex xs10 md2>
            <v-card min-width="250" max-height="120" outlined flat>
              <v-row class="fill-height">
                ...
                votes
                <div>
                  <strong style="font-size:15px">NRM</strong>
                </div>
              </v-row>
            </v-card>
          </v-flex>
          <v-flex xs10 md2>
            <v-card min-width="250" max-height="120" outlined flat>
              <v-row class="fill-height">
                ...
                votes
                <div>
                  <strong style="font-size:15px">Go Forward</strong>
                </div>
              </v-row>
            </v-card>
          </v-flex>
          <v-flex xs10 md2>
            <v-card min-width="250" max-height="120" outlined flat>
              <v-row class="fill-height">
                ...
                votes
                <div>
                  <strong style="font-size:15px">BARYA</strong>
                </div>
              </v-row>
            </v-card>
          </v-flex>
          <v-flex xs10 md2>
            <v-card min-width="250" max-height="120" outlined flat>
              <v-row class="fill-height">
                ...
                votes
                <div>
                  <strong style="font-size:15px">ABED</strong>
                </div>
              </v-row>
            </v-card>
          </v-flex>
          <v-flex xs10 md2>
            <v-card min-width="250" max-height="120" outlined class="white" flat>
              ...
              votes
              <div>
                <strong style="font-size:15px">BENON</strong>
              </div>
            </v-card>
          </v-flex>
          <v-flex xs10 md2>
            <v-card min-width="250" max-height="120" outlined flat>
              <v-row class="fill-height">
                ...
                votes
                <div>
                  <strong style="font-size:15px">KYALYA</strong>
                </div>
              </v-row>
            </v-card>
          </v-flex>
      ...
      <v-layout row wrap justify-space-around>
        <v-flex xs12 md12>
          <marquee-text :duration="15" :repeat="3" dark class="white black--text mt-2">
            <v-btn small class="blue white--text">
              <span>35.6%</span>
            </v-btn>FDC
            <v-btn small flat class="yellow accent-4 white--text">
              <span>60.2%</span>
            </v-btn>NRM
            <v-btn small flat class="green white--text">
              <span>1.2%</span>
            </v-btn>AMAMA
            <v-btn small flat class="red white--text">
              <span>0.2%</span>
            </v-btn>ABED
            <v-btn small flat class="pink white--text">
              <span>0.03%</span>
            </v-btn>BARYA
            <v-btn small flat class="black white--text">
              <span>1.2%</span>
            </v-btn>KYALYA
            <v-btn small flat class="grey white--text">
              <span>0.1%</span>
            </v-btn>JOSEPH
            <v-btn small flat class="purple white--text">
              <span>0.01%</span>
            </v-btn>BENON
          </marquee-text>
        </v-flex>
      ...
      <v-layout row wrap justify-space-around>
        <v-flex xs12 md6>
          <v-card class="pa-3" outline max-width="800" height="580px">
            <v-layout>
              <v-flex md2>
                <v-checkbox v-model="check1" @change="ch1()" label="Pie chart"></v-checkbox>
              </v-flex>
              <v-flex md2>
                <v-checkbox v-model="check2" @change="ch()" label="Bar chart"></v-checkbox>
              </v-flex>
            </v-layout>
            <div v-if="check1 === true && pieOptions.series[0].data.length">
            ...
            >
              <template slot="items" slot-scope="{ item }">
                <td class="datatable-cell-wrapper">
                  <a href="#" style="color:#0702d4;">{{ item.name }}</a>
                </td>
                <td class="datatable-cell-wrapper">
                  <div>{{ item.cand1 }}</div>
                </td>
